...
| `CLAUDE_CODE_VERSION` | `2.1.263` release candidate | reviewed Claude Code CLI release |
| `CODEX_CLI_VERSION` | `0.153.4` release candidate | reviewed Codex CLI release |
| `OMNIGENT_VERSION` | `0.12.0` release candidate | reviewed Omnigent release matched to the dedicated App protocol |
