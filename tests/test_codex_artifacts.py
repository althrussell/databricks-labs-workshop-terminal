...
def make_codex_tarballs(tmp_path):
    launcher = tmp_path / "codex-npm-0.144.6.tgz"
    native = tmp_path / "codex-npm-linux-x64-0.144.6.tgz"
    launcher_metadata = {
        "name": "@openai/codex",
        "version": VERSION,
        ...
        "optionalDependencies": {
            "@openai/codex-linux-x64": (
                "npm:@openai/codex@0.144.6-linux-x64"
            ),
            "@openai/codex-linux-arm64": (
                "npm:@openai/codex@0.144.6-linux-arm64"
            ),
            "@openai/codex-darwin-x64": (
                "npm:@openai/codex@0.144.6-darwin-x64"
            ),
            "@openai/codex-darwin-arm64": (
                "npm:@openai/codex@0.144.6-darwin-arm64"
            ),
            "@openai/codex-win32-x64": (
                "npm:@openai/codex@0.144.6-win32-x64"
            ),
            "@openai/codex-win32-arm64": (
                "npm:@openai/codex@0.144.6-win32-arm64"
            ),
        },
    }
    native_metadata = {
...
def test_validates_exact_01446_alias_and_native_layout(tmp_path):
    ...
    assert proof["alias_target"] == "npm:@openai/codex@0.144.6-linux-x64"
